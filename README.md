...
Adult survival probabilities can be estimated by first using extract.ch() then mark.ces(). Results can be plotted using plot.trend(). More details on how to do each of these can be found in the introductory manual (look in the vignettes folder or, in R by typing "vignette('cesr-intro')")
